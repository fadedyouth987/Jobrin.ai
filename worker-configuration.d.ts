/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 24013bcf7d002300f73232cdac17b770)
// Runtime types generated with workerd@1.20260831.1 2026-08-28 enable_nodejs_http_modules,enable_nodejs_http_server_modules,nodejs_compat
interface __BaseEnv_Env {
	CLOUDFLARE_WORKER: "true";
	NODE_ENV: "test" | "production";
	DEPLOYMENT_STAGE: "staging" | "production";
	APP_URL: "https://jobrin-ai-staging.nexgen-studio.workers.dev" | "https://jobrin.ai";
	CORS_ORIGINS: "https://jobrin-ai-staging.nexgen-studio.workers.dev" | "https://jobrin.ai,https://www.jobrin.ai";
	TRUST_PROXY: "1";
	REQUIRE_AAL2_SENSITIVE: "true";
	REQUIRE_EMAIL_VERIFICATION: "true";
	RECEPTIONIST_CALL: DurableObjectNamespace<import("./worker").ReceptionistCallDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ReceptionistCallDO";
	}
	interface StagingEnv {
		CLOUDFLARE_WORKER: "true";
		NODE_ENV: "test";
		DEPLOYMENT_STAGE: "staging";
		APP_URL: "https://jobrin-ai-staging.nexgen-studio.workers.dev";
		CORS_ORIGINS: "https://jobrin-ai-staging.nexgen-studio.workers.dev";
		TRUST_PROXY: "1";
		REQUIRE_AAL2_SENSITIVE: "true";
		REQUIRE_EMAIL_VERIFICATION: "true";
		RECEPTIONIST_CALL: DurableObjectNamespace<import("./worker").ReceptionistCallDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_WORKER" | "NODE_ENV" | "DEPLOYMENT_STAGE" | "APP_URL" | "CORS_ORIGINS" | "TRUST_PROXY" | "REQUIRE_AAL2_SENSITIVE" | "REQUIRE_EMAIL_VERIFICATION">> {}
}
