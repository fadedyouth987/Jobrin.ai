...
export default function App() {
  return <AuthProvider><Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-slate-50 text-sm text-slate-500">Loading Jobrin.ai…</div>}><Routes/></Suspense></AuthProvider>;
}
